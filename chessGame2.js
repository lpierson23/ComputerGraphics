...
/*
	...
	*/
    ...
    gl.bufferData( gl.ARRAY_BUFFER, flatten(boardVertices), gl.STATIC_DRAW ); //boardPoints
...
{
    boardQuad( 1, 0, 3, 2, boardPoints, vec4(0.5, 0.5, 0.5, 1.0) );
    boardQuad( 2, 3, 7, 6, boardPoints, vec4(0.5, 0.5, 0.5, 1.0) );
    boardQuad( 3, 0, 4, 7, boardPoints, vec4(0.5, 0.5, 0.5, 1.0) );
    boardQuad( 6, 5, 1, 2, boardPoints, vec4(0.5, 0.5, 0.5, 1.0) );
    boardQuad( 4, 5, 6, 7, boardPoints, vec4(0.5, 0.5, 0.5, 1.0) );
    boardQuad( 5, 4, 0, 1, boardPoints, vec4(0.5, 0.5, 0.5, 1.0) );
...
function drawGuide(texture, color){
   ...
   // var nMatrix = normalMatrix(ctMatrix, true); // return 3 by 3 normal matrix
    ...
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, vGuideBuffer);
    gl.drawElements(gl.TRIANGLES, vGuideBuffer.length, gl.UNSIGNED_SHORT, 0);
}
...
function drawBlack(texture, color){
    ...
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, vBlackBuffer);
    gl.drawElements(gl.TRIANGLES, vBlackBuffer.length, gl.UNSIGNED_SHORT, 0);
...
function drawWhite(texture, color){
   ...
   // var nMatrix = normalMatrix(ctMatrix, true); // return 3 by 3 normal matrix
    ...
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, vWhiteBuffer);
    gl.drawElements(gl.TRIANGLES, vWhiteBuffer.length, gl.UNSIGNED_SHORT, 0);
...
function drawBoard(texture, color){
    ...
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, vBoardBuffer);
    gl.drawElements(gl.TRIANGLES, vBoardBuffer.length, gl.UNSIGNED_SHORT, 0);
...
function drawKing() {
    ...
    if (blackPieces[0]["inPlay"]){
        ...
        blackQuad( 1, 0, 3, 2, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 2, 3, 7, 6, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 3, 0, 4, 7, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 6, 5, 1, 2, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 4, 5, 6, 7, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 5, 4, 0, 1, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );

        blackQuad( 9, 8, 11, 10, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 10, 11, 15, 14, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 11, 8, 12, 15, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 14, 13, 9, 10, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 12, 13, 14, 15, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 13, 12, 8, 9, kingVertices, vec4(0.0, 0.0, 0.0, 1.0) );
...
function drawQueen() {
    ...
    if (blackPieces[1]["inPlay"]){
        ...
        blackQuad( 1, 0, 3, 2, queenVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 2, 3, 7, 6, queenVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 3, 0, 4, 7, queenVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 6, 5, 1, 2, queenVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 4, 5, 6, 7, queenVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 5, 4, 0, 1, queenVertices, vec4(0.0, 0.0, 0.0, 1.0) );
    }
}
...
function drawBishop() {
    ...
    if (blackPieces[2]["inPlay"]){
        ...
        blackQuad( 1, 0, 3, 2, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 2, 3, 7, 6, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 3, 0, 4, 7, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 6, 5, 1, 2, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 4, 5, 6, 7, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 5, 4, 0, 1, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );

        blackQuad( 9, 8, 11, 10, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 10, 11, 15, 14, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 11, 8, 12, 15, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 14, 13, 9, 10, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 12, 13, 14, 15, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 13, 12, 8, 9, bishopVertices, vec4(0.0, 0.0, 0.0, 1.0) );
...
function drawKnight() {
    if (whitePieces[4]["inPlay"]){
        ...
        if (blackPieces[4]["inPlay"]){
            ...
            blackQuad( 1, 0, 3, 2, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 2, 3, 7, 6, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 3, 0, 4, 7, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 6, 5, 1, 2, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 4, 5, 6, 7, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 5, 4, 0, 1, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
    
            blackQuad( 9, 8, 11, 10, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 10, 11, 15, 14, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 11, 8, 12, 15, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 14, 13, 9, 10, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 12, 13, 14, 15, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 13, 12, 8, 9, knightVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        }
...
function drawRook() {
    ...
    if (blackPieces[6]["inPlay"]){
        ...
        blackQuad( 1, 0, 3, 2, rookVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 2, 3, 7, 6, rookVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 3, 0, 4, 7, rookVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 6, 5, 1, 2, rookVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 4, 5, 6, 7, rookVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        blackQuad( 5, 4, 0, 1, rookVertices, vec4(0.0, 0.0, 0.0, 1.0) );
...
function drawPawn() {
    ...
    for (var i = 8; i < 16; i++){
        ...
        if (blackPieces[i]["inPlay"]){
            ...
            blackQuad( 1, 0, 3, 2, pawnVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 2, 3, 7, 6, pawnVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 3, 0, 4, 7, pawnVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 6, 5, 1, 2, pawnVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 4, 5, 6, 7, pawnVertices, vec4(0.0, 0.0, 0.0, 1.0) );
            blackQuad( 5, 4, 0, 1, pawnVertices, vec4(0.0, 0.0, 0.0, 1.0) );
        }
    }
}
...
function drawPieces() {
	...
	drawBlack(blackTexture, vec4(0.5, 0.5, 0.5, 1.0));
}
